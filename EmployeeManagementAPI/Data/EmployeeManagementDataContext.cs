...
namespace EmployeeManagementAPI.Data
{
    public class EmployeeManagementDataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<Person>().Property(u => u.PersonId).Metadata.SetAfterSaveBehavior(PropertySaveBehavior.Ignore);
            modelBuilder.Entity<Person>().Property(u => u.PersonId).UseIdentityColumn();
